...
class _HomePageState extends State<HomePage> {
                  ...
                  return Container(
                    ...
                    child: Column(
                      ...
                      children :[
                        ...
                        Text(
                          '${diets[index].level} | ${diets[index].duration} | ${diets[index].duration} | ${diets[index].calorie}',
                          style : const TextStyle(
                            color: Color(0xff7B6F72),
                            fontSize: 12,
                            fontWeight: FontWeight.w400
  ...
  AppBar appBar(){
    return AppBar(
        ...
        //  child: SvgPicture.asset('assets/icons/brazilian.png',
         child: Image.asset('assets/icons/brazilian.png',
          height: 20,
          width: 20,
         )
        )),
